...
/**
 * Type personnalisé qui permet de transformer une colonne qui contient le nom d'un joueur en un objet player bukkit
 *
 * @author PixEarth
 * @version 1.0
 * @since 1.0
 */
public class PlayerBukkitType implements UserType {

    /**
     * Nom du type
     */
    public static final String CLASS_NAME = "com.pixearth.idle.models.types.PlayerBukkitType";
    ...
    public Object nullSafeGet(ResultSet resultSet, String[] data, SharedSessionContractImplementor sessionImp, Object owner) throws HibernateException, SQLException {
        ...
        String playerName = resultSet.getString(data[0]);
        if(playerName != null) {
     ...
     * @param value         Instance de l'objet (dans notre cas une instance du Joueur)
    ...
    public void nullSafeSet(PreparedStatement statement, Object value, int index, SharedSessionContractImplementor arg3) throws HibernateException, SQLException {
        ...
        final Player player = (Player) value;
        statement.setString(index, player.getName());
    }
    ...
    public Object deepCopy(Object value) throws HibernateException {
        ...
        final Player recievedParam = (Player) value;
